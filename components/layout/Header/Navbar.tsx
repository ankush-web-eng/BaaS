	...
	return (
		...
		>
			<Link href={"/"} className="flex items-start mr-4 opacity-50 h-fit">
				<Image src={''} alt="DevX logo" width={40} height={40} />
			</Link>
			...
			<Link
				href="https://github.com/ankush-web-eng/SaaS"
				target="_blank"
...
// @ts-expect-error: TypeScript does not recognize the motion.li component
